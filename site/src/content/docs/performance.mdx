...
```bash
# Syntax only, silent output, specific files
...
Tested on lodash, axios, react, moment, express, and chalk. See [benchmarks](https://github.com/yowainwright/es-check/tree/main/tests/benchmarks) for details.
