  ...
  return (
    <>
      <h2 className="text-4xl lg:text-5xl font-black">
        <span className="italic">Install</span> <span className="text-primary">ES Check</span>
      </h2>
  ...
  return (
    <div className="mt-10">
      <div className="flex items-center bg-base-300 rounded-lg shadow-sm overflow-hidden h-14 border border-base-content/10 w-fit mx-auto px-4">
        <code className="flex-1 text-left text-sm md:text-base overflow-x-auto whitespace-nowrap">{INSTALL_COMMAND}</code>
        <CopyButton />
      </div>
    </div>
  );
...
function InstallationGuideLink() {
  return (
    <div className="mt-10">
      <Link to="/docs/$slug" params={{ slug: "installation" }} className="btn btn-lg btn-primary btn-glow text-lg">
        Installation Guide
      </Link>
    </div>
  );
