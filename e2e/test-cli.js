...
try {
  execSync(`node ${esCheckPath} es5 ./tests/es5.js`, { encoding: 'utf8' });
...
try {
  execSync(`node ${esCheckPath} es5 ./tests/es6.js`, { encoding: 'utf8' });
...
try {
  execSync(`node ${esCheckPath} es6 ./tests/modules/es6-module.js --module`, { encoding: 'utf8' });
...
try {
  execSync(`node ${esCheckPath} es6 ./tests/scripts/hash-bang.js --allowHashBang`, { encoding: 'utf8' });
...
try {
  execSync(`node ${esCheckPath} es5 ./tests/es6.js --checkFeatures`, { encoding: 'utf8' });
...
try {
  execSync(`node ${esCheckPath} --config ${configPath}`, { encoding: 'utf8' });
