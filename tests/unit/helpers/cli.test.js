...
const { parseIgnoreList, generateBashCompletion, generateZshCompletion, determineInvocationType, handleESVersionError } = require('../../../lib/helpers/cli.js');
...
describe('helpers/cli.js', () => {
  ...
  describe('parseIgnoreList()', () => {
    ...
    it('should parse ignore option with multiple features', () => {
      const result = parseIgnoreList({ ignore: 'ArrowFunctions,Classes,TemplateLiterals' });
  ...
  describe('generateBashCompletion()', () => {
    it('should generate bash completion script', () => {
      const result = generateBashCompletion('es-check', ['completion', 'help'], ['version', 'module', 'light']);
  ...
  describe('generateZshCompletion()', () => {
    it('should generate zsh completion script', () => {
      const result = generateZshCompletion('es-check', ['completion', 'help'], ['version', 'module', 'light']);
