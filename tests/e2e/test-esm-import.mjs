...
import { runChecks, loadConfig, createLogger } from "../../lib/esm-wrapper.mjs";
...
log.info("Testing ESM import functionality...\n");
...
log.info("Test 2: runChecks with ES5 file");
const es5Config = [
  {
    ecmaVersion: "es5",
...
log.info("Test 3: runChecks with ES6 file against ES5 (should fail)");
const es6Config = [
  {
    ecmaVersion: "es5",
...
log.info("[PASS] Test 3 passed (expected failure)\n");

// Test 4: Test with multiple files
log.info("Test 4: runChecks with multiple files");
const multiConfig = [
  {
    ecmaVersion: "es5",
...
log.info("Test 5: loadConfig function");
...
log.info("Test 6: runChecks with custom logger");
const logs = [];
const customLogger = {
...
log.info("[PASS] All ESM import tests passed!");
