...
const IMPORT_PATTERNS = [
  {
    pattern: /(?:from\s+|require\s*\(\s*)['"]core-js\/modules\/es\.array\.to-sorted['"]/,
    feature: "ArrayToSorted",
  },
  {
    pattern: /(?:from\s+|require\s*\(\s*)['"]core-js\/modules\/es\.array\.find-last['"]/,
    feature: "ArrayFindLast",
  },
  {
    pattern: /(?:from\s+|require\s*\(\s*)['"]core-js\/modules\/es\.array\.find-last-index['"]/,
    feature: "ArrayFindLastIndex",
  },
  {
    pattern: /(?:from\s+|require\s*\(\s*)['"]core-js\/modules\/es\.array\.at['"]/,
    feature: "ArrayAt",
  },
  {
    pattern: /(?:from\s+|require\s*\(\s*)['"]core-js\/modules\/es\.string\.replace-all['"]/,
    feature: "StringReplaceAll",
  },
  {
    pattern: /(?:from\s+|require\s*\(\s*)['"]core-js\/modules\/es\.string\.match-all['"]/,
    feature: "StringMatchAll",
  },
  {
    pattern: /(?:from\s+|require\s*\(\s*)['"]core-js\/modules\/es\.string\.at['"]/,
    feature: "StringAt",
  },
  {
    pattern: /(?:from\s+|require\s*\(\s*)['"]core-js\/modules\/es\.object\.has-own['"]/,
    feature: "ObjectHasOwn",
  },
  {
    pattern: /(?:from\s+|require\s*\(\s*)['"]core-js\/modules\/es\.promise\.any['"]/,
    feature: "PromiseAny",
  },
  {
    pattern: /(?:from\s+|require\s*\(\s*)['"]core-js\/modules\/es\.regexp\.exec['"]/,
    feature: "RegExpExec",
  },
  {
    pattern: /(?:from\s+|require\s*\(\s*)['"]core-js\/modules\/es\.global-this['"]/,
    feature: "GlobalThis",
  },
];
